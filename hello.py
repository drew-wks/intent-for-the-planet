...
with tab3:
    ...
    st.markdown('<p class="body">Use this form for an initial intent session. To refine an Intent statement, use the Refine an INTENT tab.</p>', unsafe_allow_html=True)
    st.markdown('<div style="margin-top: 15px;"></div>', unsafe_allow_html=True)
    ...
    with form_container:
        with st.form(key='responses_form'):
            ...
            form_responses = {
                ...
                "who_care": st.text_area("7. Who do you care about?",placeholder="Note these down as they come to you.", help="Reflect on the people and relationships that are important to you.").split('\\n'),
