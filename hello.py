    ...
    with form_container:
        with st.form(key='intent_responses'):
            user_responses = {
                ...
                "How I care for my mental well-being": st.text_area("4. How do you care for your mental well-being?",placeholder="Similar to above. What are the things you do that give you mental peace?", help="Think about activities and practices that contribute to your mental health.").split('\\n'),
