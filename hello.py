...
<footer style="background: #f1f1f1; padding: 60px 5px 25px 20px;">
    ...
    <p class="body">ai by <span class="body" style="color: #000000;"><a href="http://www.wks.us" title="wks" style="color: #E80E10; font-weight: bold; text-decoration: none;">wks</a></span></p>
</footer>
""", unsafe_allow_html=True)
