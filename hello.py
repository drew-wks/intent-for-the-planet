...
with tab3:
    ...
    st.markdown('<p class="sub-header">Use this form for an initial intent session. To refine an Intent statement, use the Refine an INTENT tab.</p>', unsafe_allow_html=True)
    st.markdown('<div style="margin-top: 15px;"></div>', unsafe_allow_html=True)
