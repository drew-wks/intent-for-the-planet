...
<footer style="background: #f1f1f1; padding: 60px 5px 25px 20px;">
    ...
    <span class="body">ai by </span><span class="header" style="color: #000000;"><a href="http://www.wks.us" title="wks" class="header" style="color: #D70E10; font-weight: bold; text-decoration: none;">wks</a></span></p>
</footer>
""", unsafe_allow_html=True)
